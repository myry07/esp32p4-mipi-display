...
# ——最简单：无条件要求 fatfs（先编过去）
set(_lvgl_priv_requires fatfs)
...
if(LV_MICROPYTHON)
  ...
  idf_component_register(
    SRCS
      ${SOURCES} ${EXAMPLE_SOURCES} ${DEMO_SOURCES}
    INCLUDE_DIRS
      ${LVGL_ROOT_DIR} ${LVGL_ROOT_DIR}/src ${LVGL_ROOT_DIR}/../
...
set(LVGL_FATFS_SRC ${LVGL_ROOT_DIR}/src/extra/libs/fsdrv/lv_fs_fatfs.c)

# 2) 只对 lv_fs_fatfs.c 添加兼容宏，不污染其它源文件
set_source_files_properties(${LVGL_FATFS_SRC}
    PROPERTIES COMPILE_DEFINITIONS "DIR=FF_DIR;FILINFO=FF_FILINFO")
